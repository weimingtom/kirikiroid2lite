...
#else
	virtual void Play() override { __debugbreak(); throw; }
	virtual void Stop() override { __debugbreak(); throw; }
	virtual void Pause() override { __debugbreak(); throw; }
#endif
...
#else
	bool IsPlaying() const { __debugbreak(); throw; return false; }
#endif
	void FrameMove();
...
protected:
	...
	boost::mutex m_mtxPicture;
	boost::condition_variable m_condPicture;
...
#else
	BasePlayer *GetPlayer() { __debugbreak(); throw; return nullptr; }
#endif
