...
// 		}
		NaviBar.Left = static_cast<Button*>(reader.findController<cocos2d::Node>("left", false));
		NaviBar.Right = static_cast<Widget*>(reader.findController<cocos2d::Node>("right", false));
