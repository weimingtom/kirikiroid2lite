...
bool TVPGameMainMenu::init() {
	...
	_handler = reader.findController<cocos2d::Node>("handler");
	...
	_icon_touch = reader.findController<cocos2d::Node>("icon_touch");
	_icon_mouse = reader.findController<cocos2d::Node>("icon_mouse");
	setMouseIcon(true);
